...
;
num1:		.blkb 	1				; definisco tre variabili scalari num1,num2,num3 
num2:		.blkb 	1				; blkb definisce blocco di byte non iniz. (nell'esempio 1 byte)
num3:		.blkb	1				; 
num4:		.blkb	1				; num4: risultato
;
		.area   PROGRAMMA (ABS)
...
MAIN:	MOV #1,  num1
		...
		ADD num2 				;Aggiunge ad A il valore di num2
		ADD num3
		STA num4 				;STORE mette in contenuto di A nella variabile max
